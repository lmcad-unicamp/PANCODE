...
int main(int argc, char *argv[]) {
	...
	for (int c = coarsenGraph.getNumberOfCoarsenedGraphs() - 1; c >= 0; c--) {
		...
		// ----------------------//
		// ----- Comm -----//
		if ((strcmp(argv[5], "PANCODEcomm")) == 0) {
			...
			cout << "\nPANCODEcomm c: " << c - 1 << " numberOfVertices: " << coarsenGraph.getCoarsenedGraph(c)->getNumberOfVertices() << " numberOfEdges: " << coarsenGraph.getCoarsenedGraph(c)->getNumberOfEdges();
			//cout << "\ninitPart: " << ;
		...
		// ----------------------------//
		// ----- InferenceRate -----//
		} else if ((strcmp(argv[5], "PANCODEiR")) == 0) {
			...
			cout << "\nPANCODEiR c: " << c - 1 << " numberOfVertices: " << coarsenGraph.getCoarsenedGraph(c)->getNumberOfVertices() << " numberOfEdges: " << coarsenGraph.getCoarsenedGraph(c)->getNumberOfEdges();
